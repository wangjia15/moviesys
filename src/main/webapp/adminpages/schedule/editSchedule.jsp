					...
					<div class="span12">
						...
						<div class="portlet box blue">
							...
							<div class="portlet-body form">
								...
								<!-- BEGIN FORM-->
								<s:form action="updateSchedule" class="form-horizontal">
									...
									<div class="control-group">
										...
										<div class="controls">
											...
											<s:textfield name="schedule.scheduleId"
								...
								<div id="control-group alert alert-error"><s:fielderror/></div>  
									...
									<div class="control-group">
										...
										<div class="controls">
											...
											<s:textfield name="schedule.name" css="span6 m-wrap"></s:textfield>
									...
									<div class="control-group">
										...
										<div class="controls">
											...
											<s:textfield name="schedule.playtime" css="span6 m-wrap"></s:textfield>
									...
									<div class="control-group">
										...
										<div class="controls">
											...
											<s:textfield name="schedule.playdate" css="span6 m-wrap"></s:textfield>
