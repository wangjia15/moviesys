...
<body class="page-header-fixed">
				...
				<div class="row-fluid">
					...
					<div class="span12">
						...
						<h3 class="page-title">
							...
							添加演员信息<small>editable table samples</small>
					...
					<div class="span12">
						...
						<div class="portlet box blue">
							...
							<div class="portlet-body form">
								...
								<!-- BEGIN FORM-->
								<s:form action="updateactor" class="form-horizontal">
									...
									<div class="control-group">
										...
										<div class="controls">
											...
											<s:textfield name="actor.actorId" value='%{actor.actorId}'
									...
									<div class="control-group">
										...
										<div class="controls">
											...
											<s:textfield name="actor.firstName" value='%{actor.firstName}'
											  css="span6 m-wrap"></s:textfield>
									...
									<div class="control-group">
										...
										<div class="controls">
											...
											<s:textfield name="actor.lastName" value='%{actor.lastName}'  css="span6 m-wrap"></s:textfield>
	...
	<div class="control-group">
										...
										<div class="controls">
											...
											<s:textfield name="" value='%{actor.lastUpdate}'
											  css="span6 m-wrap" readonly="true"></s:textfield>
