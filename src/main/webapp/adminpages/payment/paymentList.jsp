...
<!-- 										<a href='adminpages/payment/addPayment.action' -->
									...
									<tbody>
										...
										<s:iterator value="%{paymentList}" var="payment">
											...
											<tr class="">
												...
												<td><a class="edit"
													href='adminpages/payment/getCustomerByPayment.action?id=<s:property value="#payment.paymentId" />'>客户</a></td>


												<td><a class="edit"
													href='adminpages/payment/getStaffByPayment.action?id=<s:property value="#payment.paymentId" />'>员工</a></td>

												<td><a class="edit"
													href='adminpages/payment/getSaleByPayment.action?id=<s:property value="#payment.paymentId" />'>订单</a></td>
											...
											<td><s:property value="#payment.lastUpdate" /></td>
												...
												<td><a class="edit"
													href='adminpages/payment/editPayment.action?id=<s:property value="#payment.paymentId" />'>编辑</a></td>

												<td><a class="delete" id="delbtn"
													onclick="if(confirm('确定删除?')==false)return false;"
													href='adminpages/payment/deletePayment.action?id=<s:property value="#payment.paymentId" />'>删除</a></td>
