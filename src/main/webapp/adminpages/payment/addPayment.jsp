					...
					<div class="span12">
						...
						<div class="portlet box blue">
							...
							<div class="portlet-body form">
								...
								<!-- BEGIN FORM-->
								<s:form action="savePayment" class="form-horizontal" enctype="multipart/form-data" method="post" >
								...
								<div id="control-group alert alert-error"><s:fielderror/></div>  
										...
										<div class="controls">
											...
											<select name="payment.type" css="span6 m-wrap">
									...
									<div class="control-group">
										...
										<select name="payment.active" css="span6 m-wrap">
