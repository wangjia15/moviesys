					...
					<div class="span12">
						...
						<div class="portlet box blue">
							...
							<div class="portlet-body form">
								...
								<!-- BEGIN FORM-->
								<s:form action="saveStaff" class="form-horizontal" enctype="multipart/form-data" method="post" >
								...
								<div id="control-group alert alert-error"><s:fielderror/></div>  
										...
										<div class="controls">
											...
											<select name="staff.type" css="span6 m-wrap">
									...
									<div class="control-group">
										...
										<select name="staff.active" css="span6 m-wrap">
