							...
							<div class="portlet-body">
								...
								<div class="clearfix">
									...
									<div class="btn-group">
										...
										<a href='adminpages/country/addCountry.action' class="btn green">
									...
									<tbody>
										...
										<s:iterator value="%{countryList}" var="country">
											...
											<tr class="">
												...
												<td><a class="edit"
													href='adminpages/country/getCityByCountry.action?id=<s:property value="#country.countryId" />'>城市列表</a></td>
