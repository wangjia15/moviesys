					...
					<div class="span12">
						...
						<div class="portlet box blue">
							...
							<div class="portlet-title">
								...
								<div class="caption">
									<i class="icon-reorder"></i>电影售票信息添加
								</div>
							...
							<div class="portlet-body form">
								...
								<!-- BEGIN FORM-->
								<s:form action="saveSaleinfo" class="form-horizontal"  >
								...
								<div id="control-group alert alert-error"><s:fielderror/></div>  
										...
										<div class="controls">
											...
											<select name="saleinfo.ticketType" css="span6 m-wrap">
