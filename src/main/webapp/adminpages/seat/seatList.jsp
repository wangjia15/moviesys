							...
							<div class="portlet-body">
								...
								<div class="clearfix">
									...
									<div class="btn-group">
										...
										<a href='adminpages/seat/addSeat.action' class="btn green">
									...
									<tbody>
										...
										<s:iterator value="%{seatList}" var="seat">
											...
											<tr class="">
												...
												<td><s:property value="#seat.row" /></td>
												
												<td><s:property value="#seat.column" /></td>
												
												<td><s:property value="#seat.type" /></td>
												
												
												
												<td><a class="edit"
													href='adminpages/schedule/staffList.action?id=<s:property value="#seat.seatId" />'>排片</a></td>
												

											
												<td><a class="edit"
													href='adminpages/seat/editSeat.action?id=<s:property value="#seat.seatId" />'>编辑</a></td>

												<td><a class="delete" id="delbtn"
													onclick="if(confirm('确定删除?')==false)return false;"
													href='adminpages/seat/deleteSeat.action?id=<s:property value="#seat.seatId" />'>删除</a></td>
