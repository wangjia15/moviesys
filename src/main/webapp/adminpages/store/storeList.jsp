							...
							<div class="portlet-body">
								...
								<div class="clearfix">
									...
									<div class="btn-group">
										...
										<a href='adminpages/store/addStore.action' class="btn green">
									...
									<tbody>
										...
										<s:iterator value="%{storeList}" var="store">
											...
											<tr class="">
												...
												<td><a class="edit"
													href='adminpages/store/getManagerByStore.action?id=<s:property value="#store.storeId" />'>经理信息</a></td>
												
						<td><a class="edit"
													href='adminpages/store/getStaffByStore.action?id=<s:property value="#store.storeId" />'>员工信息</a></td>
												

												<td><a class="edit"
													href='adminpages/address/getAddressByStore.action?id=<s:property value="#store.storeId" />'>地址</a></td>


												<td><a class="edit"
													href='adminpages/hall/hallList.action?id=<s:property value="#store.storeId" />'>播放厅列表</a></td>

												<td><a class="edit"
													href='adminpages/customer/getCustomerByStore.action?id=<s:property value="#store.storeId" />'>客户列表</a></td>


												<td class="center"><s:property
														value="#store.lastUpdate" /></td>

												<td><a class="edit"
													href='adminpages/store/editStore.action?id=<s:property value="#store.storeId" />'>编辑</a></td>

												<td><a class="delete" id="delbtn"
													onclick="if(confirm('确定删除?')==false)return false;"
													href='adminpages/store/deleteStore.action?id=<s:property value="#store.storeId" />'>删除</a></td>
