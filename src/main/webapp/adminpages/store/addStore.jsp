		...
		<div class="page-content">
			...
			<div class="container-fluid">
				...
				<div class="row-fluid">
					...
					<div class="span12">
						...
						<div class="portlet box blue">
							...
							<div class="portlet-body form">
								...
								<!-- BEGIN FORM-->
								<s:form action="saveStore" class="form-horizontal" >
								...
								<div id="control-group alert alert-error"><s:fielderror/></div>  
									...
									<div class="control-group">
										...
										<div class="controls">
											...
											<s:textfield name="store.name" css="span6 m-wrap"></s:textfield>
			        ...
			        <select class="js-data-example-ajax" onchange="getTest();" name="staffId"  >
			        ...
			        <select class="js-data-example-ajax2" onchange="getTest2();" name="addressId"  >
...
//	 			        }
			...
			$(".js-data-example-ajax2").select2({
				...
				// placeholder: "YYYYYYYY",
				  ...
				  ajax: {
				    url: "http://localhost:8080/ajax/searchAddress.action",
				    dataType: 'json',
				    delay: 1000,
				    data: function (params) {
				      return {
