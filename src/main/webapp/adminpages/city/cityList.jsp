							...
							<div class="portlet-body">
								...
								<div class="clearfix">
									...
									<div class="btn-group">
										...
										<a href='adminpages/city/addCity.action' class="btn green">
									...
									<tbody>
										...
										<s:iterator value="%{cityList}" var="city">
											...
											<tr class="">
												...
												<td><s:property value="#city.cityId" /></td>

												<td><s:property value="#city.cityName" /></td>
												
												<td><s:property value="#city.country.countryName" /></td>



												<td class="center"><s:property
														value="#city.lastUpdate" /></td>

												<td><a class="edit"
													href='adminpages/city/getAddressByCity.action?id=<s:property value="#city.cityId" />'>地址列表</a></td>

												<td><a class="edit"
													href='adminpages/city/editCity.action?id=<s:property value="#city.cityId" />'>编辑</a></td>

												<td><a class="delete" id="delbtn"
													onclick="if(confirm('确定删除?')==false)return false;"
													href='adminpages/city/deleteCity.action?id=<s:property value="#city.cityId" />'>删除</a></td>
