					...
					<div class="span12">
						...
						<div class="portlet box blue">
							...
							<div class="portlet-body form">
								...
								<!-- BEGIN FORM-->
								<s:form action="saveCountry" class="form-horizontal" >
								...
								<div id="control-group alert alert-error"><s:fielderror/></div>  
									...
									<div class="control-group">
										...
										<div class="controls">
											...
											<s:textfield name="country.countryName" css="span6 m-wrap"></s:textfield>
									...
									<div class="control-group">
										...
										<s:select name="languageid" list="#request.CountryList" 
