								...
								<div id="control-group alert alert-error"><s:fielderror/></div>  
									...
									<div class="control-group">
										...
										<div class="controls">
											...
											<s:textfield name="film.rating" css="span6 m-wrap"></s:textfield>
										...
										class="span6 m-wrap" value="film.languageByLanguageId.languageId" >
										...
										<div class="controls">
											...
											<s:textfield name="film.name" css="span6 m-wrap"></s:textfield>
										...
										<div class="controls">
											...
											<s:textfield name="film.specialFeatures" css="span6 m-wrap"></s:textfield>
