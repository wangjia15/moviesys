					...
					<div class="span12">
						...
						<div class="portlet box blue">
							...
							<div class="portlet-body form">
								...
								<!-- BEGIN FORM-->
								<s:form action="saveCategory" class="form-horizontal" >
								...
								<div id="control-group alert alert-error"><s:fielderror/></div>  
									...
									<div class="control-group">
										...
										<div class="controls">
											...
											<s:textfield name="category.name" css="span6 m-wrap"></s:textfield>
